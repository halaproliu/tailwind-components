<template>
  ...
  <div class="flex h-full">
          ...
          <div class="flex-1">
            ...
            >
              <a
                ...
                :key="item.name"
                :href="item.href"
                class="flex items-center rounded-lg p-4 text-indigo-200 hover:bg-indigo-700"
              >
    ...
    <div class="flex min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <div class="lg:hidden">
        <div
          class="flex items-center justify-between bg-indigo-600 px-4 py-2 sm:px-6 lg:px-8"
        >
          <div>
            <img
              class="h-8 w-auto"
          ...
          <div>
            <button
              type="button"
              class="-mr-3 inline-flex h-12 w-12 items-center justify-center rounded-md bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
      ...
      <main class="flex flex-1 overflow-hidden">
        ...
        <aside class="hidden lg:order-first lg:block lg:flex-shrink-0">
          <div
            class="relative flex h-full w-96 flex-col overflow-y-auto border-r border-gray-200 bg-white"
          >
            <!-- Your content -->
          </div>
        </aside>
